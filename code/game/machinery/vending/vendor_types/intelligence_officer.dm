...
GLOBAL_LIST_INIT(cm_vending_gear_intelligence_officer, list(
		...
		list("APC Circuit Board", 5, /obj/item/circuitboard/apc, null, VENDOR_ITEM_REGULAR),
...
GLOBAL_LIST_INIT(cm_vending_clothing_intelligence_officer, list(
		...
		list("XM12 Officer Helmet", 0, /obj/item/clothing/head/helmet/marine/intel, MARINE_CAN_BUY_HELMET, VENDOR_ITEM_RECOMMENDED),
		...
		list("Mini Radio Telephone Pack", 0, /obj/item/storage/backpack/marine/satchel/rto/small, MARINE_CAN_BUY_BACKPACK, VENDOR_ITEM_REGULAR),
